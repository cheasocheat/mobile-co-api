...
public class QuotationApplicantController {
    ...
    public String getQuotationApplicantByTemplate(@RequestParam(value = "lastUpdate", required = false) String lastUpdate,
        ...
        if (product != null && !product.equals("") && product.equals("HD")){
            return restTemplate.exchange(Route.HD_BASE_URL + "/quotationapplicant/list_quotationapplicant", HttpMethod.POST, entity, String.class).getBody();
        }else {
